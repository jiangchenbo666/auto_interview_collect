...
CATEGORY_KEYWORDS: list[tuple[str, tuple[str, ...]]] = [
    ...
    ("数据库", ("数据库", "mysql", "sql", "索引", "事务", "锁", "慢查询")),
    ("计算机网络", ("tcp", "udp", "http", "https", "三次握手", "四次挥手", "网络")),
    ("操作系统", ("进程", "线程", "死锁", "内存", "上下文切换", "io")),
    ("Linux", ("linux", "shell", "grep", "awk", "sed", "chmod", "日志")),
    ...
    ("Docker 与云原生", ("docker", "容器", "k8s", "kubernetes", "镜像")),
    ("项目经历", ("项目", "实习", "难点", "负责", "经历")),
